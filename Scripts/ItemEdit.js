var DNNAudioPlaylist = DNNAudioPlaylist || {};

DNNAudioPlaylist.itemViewModel = function (moduleId, resx) {
    var service = {
        path: "DNNAudioPlaylist",
    ...
    var loadUsers = function (data) {
        ...
        for (var i = 0; i < data.length; i++) {
            var result = data[i];
            var user = new DNNAudioPlaylist.user(result.id, result.name);
...
DNNAudioPlaylist.user = function (id, name) {
    this.id = id;
    this.name = name;
}